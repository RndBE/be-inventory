...
class GaransiProjekExport implements FromArray, WithHeadings, ShouldAutoSize, WithStyles, WithTitle
{
    protected $projek_id;
    ...
    public function array(): array
    {
        ...
        $totalQty = 0;
        $totalSubTotal = 0;
        $projek = GaransiProjek::with('garansiProjekDetails.dataBahan', 'garansiProjekDetails.dataBahan.dataUnit', 'garansiProjekDetails.dataProduk',)->findOrFail($this->projek_id);
