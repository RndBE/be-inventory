...
class AuthController extends Controller
{
    ...
    //             'email' => "Akun dikunci. Coba lagi dalam $remaining.",
    //         ]);
    //     }
    ...
    //     // 🔒 Rate limiter key berdasarkan email
    //     $key = 'login-attempt:' . strtolower($request->email);

    //     if (RateLimiter::tooManyAttempts($key, 3)) {
    //         // Jika gagal 3x, kunci akun selama 5 menit
    //         if ($user) {
    //             $user->locked_until = Carbon::now()->addMinutes(1);
    //             $user->save();
    //         }

    //         RateLimiter::clear($key);
    //         throw ValidationException::withMessages([
    //             'email' => 'Terlalu banyak percobaan login gagal. Akun dikunci selama 5 menit.',
    //         ]);
    //     }
