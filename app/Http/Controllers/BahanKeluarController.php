...
class BahanKeluarController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('permission:edit-bahan-keluar', ['only' => ['update','edit','updatepengambilan']]);
    ...
    public function downloadPdf(int $id)
    {
        try {
            ...
            $bahanKeluar = BahanKeluar::with('bahanKeluarDetails')->findOrFail($id);

            // Pass the record to the view
            $pdf = Pdf::loadView('pages.bahan-keluars.pdf', compact('bahanKeluar'));

            // Return the generated PDF
            return $pdf->download("bahan_keluar_{$id}.pdf");
            // return view('pages.bahan-keluars.pdf', compact('bahanKeluar'));
        } catch (\Exception $e) {
