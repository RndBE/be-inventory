...
class EditKomponenSampleCart extends Component
{
     ...
     * sesi ini - baris lama datang dari `$produkSampleDetails`. Peta ini
    ...
    public function addToCart($bahan)
    {
        ...
        $itemExists = collect($this->produkSampleDetails)->first(function ($item) use ($cartKey) {
        ...
        // Tambahkan juga ke produkSampleDetails
        $this->produkSampleDetails[] = [
            'cart_key' => $cartKey,
            'bahan_id' => $bahan->bahan_id ?? null,
            'produk_id' => $bahan->produk_id ?? null,
    ...
    public function updateQuantity($type, $cartKey)
    {
        ...
        $detail = collect($this->produkSampleDetails)->firstWhere('cart_key', $cartKey);
        if (!$detail) {
            return;
        }
    ...
    public function removeItem($cartKey)
    {
        ...
        $this->produkSampleDetails = array_filter($this->produkSampleDetails, function ($detail) use ($cartKey) {
    ...
    public function returnToProduction($type, $itemId, $unitPrice)
    {
        ...
        // Tidak perlu update produkSampleDetails atau qty
        $this->calculateTotalHarga();
    }
    ...
    public function render()
    {
        ...
        return view('livewire.edit-komponen-sample-cart', [
            'cartItems' => $this->cart,
