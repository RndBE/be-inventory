<div class="mobile-menu md:hidden">
    <div class="mobile-menu-bar">
        <a href="" class="flex mr-auto">
            <img alt="BE Logo" class="w-6" src="{{ asset('dist/images/logo.svg')}}">
        </a>
    ...
    <ul class="border-t border-theme-24 py-5 hidden">
        <li>
            <a href="{{ route('quality-page.index') }}"
                class="menu {{ request()->routeIs('quality-page.index') ? 'menu--active' : '' }}">
        ...
        <li>
            ...
            <a href="javascript:;" class="menu {{ $isGudangActive ? 'menu--active' : '' }}">
            ...
            {{-- @endif --}}
            <ul class="{{ $isGudangActive ? 'menu__sub-open' : '' }}">
                <li>
                    <a href="{{ route('quality-page.qc-bahan-masuk.index') }}"
                        class="menu {{ request()->routeIs('quality-page.qc-bahan-masuk.index') ? 'menu--active' : '' }}">
                        <div class="menu__icon"> <i data-feather="activity"></i> </div>
                        <div class="menu__title"> QC Bahan Masuk </div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li>
            ...
            @php
                $isProduksiActive = request()->routeIs('quality-page.qc-produk-setengah-jadi.*')
                    || request()->routeIs('quality-page.qc-produk-jadi.*');
            @endphp
            <a href="javascript:;" class="menu {{ $isProduksiActive ? 'menu--active' : '' }}">
            ...
            <ul class="{{ $isProduksiActive ? 'menu__sub-open' : '' }}">
                ...
                <li>
                    <a href="{{ route('quality-page.qc-produk-jadi.index') }}"
                        ...
                        <div class="menu__title"> QC Produk Jadi</div>
                    </a>
                </li>
            </ul>
        </li>
