<div class="min-w-fit">
    ...
    >
        ...
        <div class="space-y-8">
            ...
            <!-- Master Data -->
            <div>
                @role('superadmin|purchasing|produksi|administrasi|admin')
                <h3 class="text-xs uppercase text-gray-400 dark:text-gray-500 font-semibold pl-3">
                    <span class="hidden lg:block lg:sidebar-expanded:hidden 2xl:hidden text-center w-6" aria-hidden="true">•••</span>
                ...
                <ul class="mt-3">
                    ...
                    @endrole
                    <!-- Transaksi -->
                    @role('superadmin|purchasing|administrasi|admin')
            ...
            <!-- Produksi -->
            @role('superadmin|produksi|purchasing|administrasi|admin')
            <div>
                <h3 class="text-xs uppercase text-gray-400 dark:text-gray-500 font-semibold pl-3">
                    <span class="hidden lg:block lg:sidebar-expanded:hidden 2xl:hidden text-center w-6" aria-hidden="true">•••</span>
            ...
            @endrole
            <!-- RnD -->
            @role('superadmin|rnd|administrasi|admin')
            <div>
                <h3 class="text-xs uppercase text-gray-400 dark:text-gray-500 font-semibold pl-3">
                    <span class="hidden lg:block lg:sidebar-expanded:hidden 2xl:hidden text-center w-6" aria-hidden="true">•••</span>
