        ...
        <ul class="{{ $isProduksiActive ? 'side-menu__sub-open' : '' }}">
            ...
            <li>
                <a href="{{ route('quality-page.qc-produk-setengah-jadi.index') }}"
                    class="side-menu {{ request()->routeIs('quality-page.qc-produk-setengah-jadi.*') ? 'side-menu--active' : '' }}">
                    <div class="side-menu__icon">
                        <!-- icon setengah jadi -->
            ...
            <li>
                <a href="{{ route('quality-page.qc-produk-jadi.index') }}"
                    class="side-menu {{ request()->routeIs('quality-page.qc-produk-jadi.*') ? 'side-menu--active' : '' }}">
                    <div class="side-menu__icon">
                        <!-- icon produk jadi -->
                    ...
                    <div class="side-menu__title"> QC Produk Jadi</div>
                </a>
            </li>
        </ul>
    </li>
