<div>
    <div class="border-b border-gray-900/10 pb-2 mb-2">
        <div class="grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-2">
            <div class="flex items-center">
                <label for="kode_pengajuan" class="block text-sm font-medium leading-6 text-gray-900 mr-2 w-1/4">Kode
                    Pengajuan</label>
                <input type="text" id="kode_pengajuan" disabled placeholder="PB - "
            ...
            <div class="flex items-center">
                ...
                <select name="divisi" id="divisi"
                    ...
                    <option value="Administrasi" {{ old('divisi') == 'Administrasi' ? 'selected' : '' }}>Administrasi
                    </option>
                    <option value="General Affair" {{ old('divisi') == 'General Affair' ? 'selected' : '' }}>General
                        Affair</option>
                    ...
                    <option value="Sekretaris" {{ old('divisi') == 'Sekretaris' ? 'selected' : '' }}>Sekretaris
                    </option>
            ...
            <div class="flex items-center">
                ...
                <textarea id="keterangan" name="keterangan"
                    class="w-3/4 block rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{ old('keterangan') }}</textarea>
            </div>
                                    ...
                                    <tr
                                        ...
                                        <td class="px-6 py-4">
                                            <a href="#"
                                                ...
                                                wire:click.prevent="removeItem({{ $item->id }})"><svg
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg pt-0">
                <div>
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            @foreach ($itemsAset as $index => $item)
                                <input type="hidden" name="itemsAset"
                                    value="{{ json_encode($this->getCartItemsForAset()) }}">
                                <tr
                                    class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    <td class="px-6 py-4">
                                        <input type="text"
                                            wire:model.live="itemsAset.{{ $index }}.nama_bahan"
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <input type="number"
                                            wire:model.live="itemsAset.{{ $index }}.jml_bahan"
                                            class="w-20 border border-gray-300 text-gray-900 rounded-lg px-2 py-1 text-center">
                                    </td>
                                    <td class="px-6 py-4">
                                        <input type="text"
                                            wire:model.live="itemsAset.{{ $index }}.penanggungjawabaset"
                                            class="w-full border border-gray-300 text-gray-900 rounded-lg px-2 py-1">
                                    </td>
                                    <td class="px-6 py-4">
                    ...
                    <div class="flex justify-end m-4">
                        <button wire:click.prevent="addRow" class="bg-indigo-600 text-white p-8 px-4 py-2 rounded">
                            Tambah Baris
                        </button>
                    </div>
                </div>
    ...
    @if ($jenisPengajuan == 'Pembelian Aset Impor')
        <div class=" border-gray-900/10 pt-2">
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg pt-0">
                <div>
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
