        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                @foreach ($cart as $item)
                    ...
                    {{-- <input type="hidden" name="cartItems" value='@json($this->getCartItemsForStorage())'> --}}
                    <tr
                        class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white">{{ $item->nama_bahan }}
                        ...
                        <td class="px-6 py-4">
                            <div class="flex justify-center items-center">
                                <textarea class="w-full px-2 py-1 border bg-transparent focus:ring-0"
