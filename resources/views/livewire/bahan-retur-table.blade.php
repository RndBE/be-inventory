                    ...
                    @forelse($bahan_returs as $index => $bahan_retur)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <button class="text-blue-600 hover:underline" type="button" wire:click="showBahanRetur({{$bahan_retur->id}})" data-modal-target="showbahanretur-modal" data-modal-toggle="showbahanretur-modal">
