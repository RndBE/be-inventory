<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-2">
        ...
        <div class="mb-4 sm:mb-0">
            ...
            <h6 class="text-2xl text-gray-800 dark:text-gray-100 font-bold">Produk Setengah Jadi</h6>
        </div>
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-4 py-3 text-center align-middle">
                            <x-link-gambar-thumb :link="$bahanSetengahjadi->link_gambar"
                                :alt="'Foto produk ' . $bahanSetengahjadi->kode_transaksi"
                                :wire-click="'lihatGambar(' . $bahanSetengahjadi->id . ')'" />
                        </td>
                        <td class="px-6 py-3">
                        ...
                        <td class="px-6 py-4">
                            <div class="row flex space-x-2">
                                ...
                                @can('edit-link-gambar-produk')
                                    <button type="button" wire:click="editLinkGambar({{ $bahanSetengahjadi->id }})"
                                        ...
                                        title="{{ $bahanSetengahjadi->link_gambar ? 'Ubah tautan gambar' : 'Tambah tautan gambar' }}">
