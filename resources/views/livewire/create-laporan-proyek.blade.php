                    ...
                    <div class="grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-2">
                        ...
                        <div class="flex flex-col mt-6 w-full">
                            <table class="w-full border-collapse">
                                <tbody>
                                    <tr>
                                        <td class="px-4 py-2 font-medium text-gray-900 w-1/3 self-start">Mulai Kontrak</td>
                                        <td class="px-4 py-2 w-2/3 self-start">
                                            {{ \Carbon\Carbon::parse($proyek->dataKontrak->mulai_kontrak)->translatedFormat('j F Y') ?? 'Tidak Ada Data' }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="px-4 py-2 font-medium text-gray-900 w-1/3 self-start">Selesai Kontrak</td>
                                        <td class="px-4 py-2 w-2/3 self-start">
                                        ...
                                        <div id="accordion-flush-{{ $index }}" data-accordion="collapse"
                                            ...
                                            <h2 id="accordion-flush-heading-{{ $index }}">
                                                <button type="button"
                                                    ...
                                                    <svg data-accordion-icon class="w-3 h-3 shrink-0 transition-transform duration-200 ease-in-out"
                                            ...
                                            aria-labelledby="accordion-flush-heading-{{ $index }}" class="overflow-x-auto">
                                                <div class="relative overflow-x-auto shadow-md">
                                                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                                            <tr>
                                                                <th scope="col" class="px-6 py-3">Nama Bahan/Produk</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach ($detail['bahan_rusak_details'] as $detailItem)
                                                                @php
                                                                    ...
                                                                    $currentSubTotal = is_array($detailItem) ? ($detailItem['sub_total'] ?? 0) : ($detailItem->sub_total ?? 0);
                                                            ...
                                                            <tr class="bg-gray-100 dark:bg-gray-900 font-semibold">
                                                                ...
                                                                <td class="px-6 py-4 text-right">Rp. {{ number_format($subTotalBahanRusak, 2, ',', '.') }}</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                    ...
                                    <div class="relative overflow-x-auto shadow-md">
                                        <table class="w-full text-lg text-left text-gray-500 dark:text-gray-400">
                                            <thead class="text-sm text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                                <tr>
                                                    <th scope="col" class="px-6 py-3 text-right">Total Harga Keseluruhan</th>
                                                    <th scope="col" class="px-6 py-3 text-right">Rp. {{ number_format($totalHargaBahanRusak, 2, ',', '.') }}</th>
                                                </tr>
                                            </thead>
                                        </table>
                                    </div>
                        ...
                        <div class="flex flex-col mt-6 w-full">
                            <table class="w-full border-b border-collapse">
                                ...
                                <tr class="bg-gray-200 font-bold">
                                    <td class="px-4 py-2 font-medium text-gray-900 self-start text-right">Total:</td>
                                    <td class="px-4 py-2 text-right">
