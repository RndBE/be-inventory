        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <input type="hidden" name="garansiProjekDetails" value="{{ json_encode($this->getCartItemsForStorage()) }}">
                        ...
                        <td class="px-6 py-4 text-gray-900 dark:text-white text-center">
                            <div class="flex items-center">
                                @php
                                    ...
                                    $labelBatangBaris = $panjangStandarBaris ? $this->namaUnitUntuk($bahanId) : null;
                                @endphp
                                ...
                                @if ($bahanId)
                                    ...
                                    @if ($panjangStandarBaris)
                                        <select wire:model="satuan.{{ $bahanId }}" wire:change="updateSatuan({{ $bahanId }})"
                            ...
                            @if ($panjangStandarBaris)
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                    keluar {{ number_format($this->qtyDasar($bahanId), 0, ',', '.') }} cm
