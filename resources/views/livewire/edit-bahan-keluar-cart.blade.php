                        ...
                        <td class="px-6 py-4 text-gray-900 dark:text-white text-center">
                            <div class="flex items-center">
                                <input
                                    ...
                                    placeholder="0" min="0"
                                    value="{{ old('qty.'.($detail['bahan_id'] ?? $detail['produk_id'] ?? $detail['produk_jadis_id']), $qty[$detail['bahan_id'] ?? $detail['produk_id'] ?? $detail['produk_jadis_id']] ?? 0) }}" readonly
                                />
                            </div>
                        </td>
