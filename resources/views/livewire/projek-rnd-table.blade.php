            ...
            <ul class="flex flex-wrap -m-1">
                ...
                <li class="m-1">
                    @can('lihat-projek-rnd')
                        <a href="{{ route('projek-rnd.exportAll', ['search' => $search]) }}" class="mt-2 inline-flex items-center gap-1 w-fit rounded-md py-1.5 px-2 bg-green-600 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">
                        ...
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <div class="row flex space-x-2">
                                    <a href="{{ route('projek-rnd.info', $projek_rnd->id) }}" class="rounded-md border border-slate-300 py-1 px-2 text-center text-xs transition-all shadow-sm hover:shadow-lg text-slate-600 hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 active:border-red-600 active:text-white active:bg-red-600 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" type="button">
                                    ...
                                    @if(in_array($projek_rnd->status, ['Dalam Proses', 'Selesai', 'Selesai Belum Laku']))
