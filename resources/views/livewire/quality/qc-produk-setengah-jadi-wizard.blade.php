<div>
    ...
    <div class="intro-y box py-10 sm:py-20 mt-5">
        ...
        <div class="px-5 sm:px-20 mt-10 pt-10 border-t border-gray-200">
            @includeWhen($step === 1, 'livewire.quality.steps-qc-produk-setengah-jadi.step-1-informasi')
            @includeWhen($step === 2, 'livewire.quality.steps-qc-produk-setengah-jadi.step-2-detail-produk')
        </div>
