    ...
    <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
            ...
            x-data="{
                ...
                selectActiveItem() {
                    if (this.activeIndex >= 0 && this.activeIndex < this.items.length) {
                        $wire.set('selected_produksi_id', this.items[this.activeIndex]);
                        this.open = false;
                    }
                }
            }"
        ...
        >
            ...
            <div @click="openDropdown"
                ...
                <span>
                    {{ $selected_produksi_id
                        ? optional($produksiList->firstWhere('id', $selected_produksi_id))->kode_produksi
                        : 'Pilih Kode Produksi' }}
                </span>
            ...
            <div x-show="open"
                ...
                <div x-effect="items = @js($this->filteredProduksiSetengahJadiList->pluck('id')->values());
                ...
                <ul style="max-height: 240px; overflow-y: auto; padding: 0; margin: 0;" x-ref="listContainer">
                    @forelse ($this->filteredProduksiSetengahJadiList as $index => $produksi)
                        <li
                            x-ref="item{{ $index }}"
                            :class="{
