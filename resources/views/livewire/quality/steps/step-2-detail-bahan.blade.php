                    ...
                    @foreach ($selectedBahanList as $index => $bahan)
                        <div wire:key="bahan-card-{{ $bahan['bahan_id'] }}"
                            ...
                            x-data="{
                                ...
                                isSelected: @entangle('selectedBahanList.' . $index . '.is_selected'),
                                adjustFisik() {
                            ...
                            <div :class="!isSelected ? 'opacity-50 pointer-events-none' : ''">
                                <div>
                                    <label class="text-lg text-black">No Invoice</label>
                                    <input type="text" wire:model.lazy="selectedBahanList.{{ $index }}.no_invoice"
                                        class="input border w-full mt-1" placeholder="INV-0001" :disabled="!isSelected">
                                ...
                                <div class="grid grid-cols-2 gap-2 text-lg">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01"
                                            ...
                                            :disabled="!isSelected"
                                            class="input border w-full mt-1 text-lg" placeholder="100">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01"
                                            ...
                                            :disabled="!isSelected"
                                            @input="adjustFisik()"
                                            class="input border w-full mt-1 text-lg" placeholder="98">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01"
                                            ...
                                            :disabled="!isSelected"
                                            @input="adjustFisik()"
                                            class="input border w-full mt-1 text-lg" placeholder="2">
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <select
                                            ...
                                            :disabled="!isSelected"
                                            class="input border w-full mt-1 text-lg"
                                        >
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <textarea type="text" wire:model.lazy="selectedBahanList.{{ $index }}.notes"
                                            class="input border w-full mt-1 text-lg" placeholder="Opsional..." :disabled="!isSelected"></textarea>
                                    </div>
