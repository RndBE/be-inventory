<div>
    <div class="border-gray-900/10 pt-2">
                        ...
                        @foreach ($pembelianBahanDetails as $detail)
                            ...
                            <tr
                                ...
                                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white text-right">
                                    <span>
                                        {{ number_format($unit_price[$detail['bahan']->id] ?? ($detail['details']['unit_price'] ?? 0), 2, ',', '.') }}
                                    </span>
                                </td>
                                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white text-right">
                                    @if ($editingItemId === $detail['bahan']->id)
                                        <input autofocus wire:model="new_unit_price_raw.{{ $detail['bahan']->id }}"
                                            type="text"
                                    ...
                                    @else
                                        <span class="cursor-pointer"
                                            wire:click="editItemPrice({{ $detail['bahan']->id }})">
                                            {{ number_format(
                                                $new_unit_price[$detail['bahan']->id] ?? ($new_detail['new_details']['new_unit_price'] ?? 0),
                                                2,
                                                ',',
                                                '.',
                                            ) }}
                                ...
                                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white text-right">
                                    ...
                                    @else
                                        <span
                                            class="line-through text-red-500">{{ number_format($subTotal, 2, ',', '.') }}</span>
                                        <span
                                            class="font-semibold ml-2">{{ number_format($newSubTotal, 2, ',', '.') }}</span>
                                    @endif
                                </td>
                                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white">
                                    <div class="flex justify-right items-right">
                                        <textarea wire:model="keterangan_pembayaran.{{ $detail['bahan']->id }}"
                                            ...
                                            class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block px-2.5 py-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ $detail['keterangan_pembayaran'] ?? '' }}</textarea>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
                        @foreach (['PPN' => 'ppn', 'Ongkos Kirim' => 'ongkir', 'Asuransi' => 'asuransi', 'Layanan' => 'layanan', 'Jasa Aplikasi' => 'jasa_aplikasi'] as $label => $field)
                            <tr
                                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <td colspan="3"></td>
                                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white text-right">
                                ...
                                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white text-right">
                                    @if ($editingItemId === $field)
                                        <input autofocus wire:model="{{ $field }}_raw" type="text"
                                            class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block px-2.5 py-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-right"
                                            placeholder="0" wire:blur="formatToRupiah('{{ $field }}')" />
                                    @else
                        ...
                        <tr
                            ...
                            <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white text-right">
                                @php
                                    ...
                                    $totalWithExtras =
                                        $grandTotal + $ppn + $ongkir + $asuransi + $layanan + $jasa_aplikasi;
                                @endphp
                                <strong>Rp.</strong> {{ number_format($totalWithExtras, 2, ',', '.') }}
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        @php
                            ...
                            $biayaTambahanUSD =
                                ($new_shipping_cost_usd > 0 ? $new_shipping_cost_usd : $shipping_cost_usd) +
                        ...
                        @foreach ($pembelianBahanDetails as $detail)
                            ...
                            <tr
                                ...
                                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white text-right">
                                    ...
                                    @else
                                        <span class="cursor-pointer"
                                            wire:click="editItemPriceUSD('usd',{{ $detail['bahan']->id }})">
                                            {{ number_format(
                                                $new_unit_price_usd[$detail['bahan']->id] ?? ($detail['new_details_usd']['new_unit_price_usd'] ?? 0),
                                                2,
                                                ',',
                                                '.',
                                            ) }}
                                ...
                                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white text-right">
                                    ...
                                    @else
                                        <span
                                            class="line-through text-red-500">{{ number_format($subTotalUSD, 2, ',', '.') }}</span>
                                        <span
                                            class="font-semibold ml-2">{{ number_format($newSubTotalUSD, 2, ',', '.') }}</span>
                                    @endif
                                </td>
                                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white text-right">
                                    <span>
                                ...
                                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white text-right">
                                    ...
                                    @else
                                        <span class="cursor-pointer"
                                            wire:click="editItemPriceUSD('idr',{{ $detail['bahan']->id }})">
                                            {{ number_format(
                                                $new_unit_price[$detail['bahan']->id] ?? ($detail['details']['new_unit_price'] ?? 0),
                                                2,
                                                ',',
                                                '.',
                                            ) }}
        ...
        'Value Today Fee' => ['new_value_today_fee_usd', 'new_value_today_fee'],] as $label => $fields)
                            <tr
                                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <!-- Kolom Label -->
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-200 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-right w-0.5">Keterangan/Alasan Pembelian Aset
                            </th>
                    ...
                    <tbody>
                        ...
                        @foreach ($pembelianBahanDetails as $detail)
                            ...
                            <input type="hidden" name="pembelianBahanDetails"
                                value="{{ json_encode($this->getCartItemsForStorageAset()) }}">
                            <input type="hidden" name="biaya"
                                value="{{ json_encode($this->getCartItemsForStorageBiaya()) }}">
                            <tr
                                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white text-right">
                                    <span>
                                        {{ number_format($unit_price[$bahanKey] ?? ($detail['details']['unit_price'] ?? 0), 2, ',', '.') }}
                                    </span>
                                </td>
                                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white text-right">
                                    @if ($editingItemId === $bahanKey)
                                        <input autofocus wire:model="new_unit_price_raw.{{ $bahanKey }}"
                                            type="text"
                                            class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block px-2.5 py-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-right"
                                            placeholder="0" wire:blur="formatToRupiahPrice('{{ $bahanKey }}')" />
                                    @else
                                        <span class="cursor-pointer"
                                            wire:click="editItemPrice('{{ $bahanKey }}')">
                                            {{ number_format(
                                                $new_unit_price[$bahanKey] ?? ($new_detail['new_details']['new_unit_price'] ?? 0),
                                                2,
                                                ',',
                                                '.',
                                            ) }}
                                ...
                                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white">
                                    <div class="flex justify-right items-right">
                                        <textarea wire:model="keterangan_pembayaran.{{ $bahanKey }}"
        ...
        @if ($jenis_pengajuan === 'Pembelian Aset Impor')
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-200 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            <th class="px-6 py-3 w-1/5">Nama</th>
                            ...
                            <th class="px-6 py-3 text-right">Total Harga (Rp)</th>

                            <th class="px-6 py-3 text-center">Penanggung Jawab Aset</th>
                            <th class="px-6 py-3 text-center">Alasan</th>
                            <th class="px-6 py-3">Tujuan Pembayaran</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($pembelianBahanDetails as $detail)
                            @php
                                ...
                                // USD
                                $usdOld =
                                    $unit_price_usd_aset[$safeKey] ??
                                    ($detail['details_usd']['unit_price_usd_aset'] ?? 0);
                                $usdNew =
                                    $new_unit_price_usd_aset[$safeKey] ??
                                    ($detail['details_usd']['new_unit_price_usd_aset'] ?? 0);
                                $usdFinal = $usdNew > 0 ? $usdNew : $usdOld;

                                // IDR
                                $idrOld = $unit_price_aset[$safeKey] ?? ($detail['details']['unit_price'] ?? 0);
                                $idrNew = $new_unit_price_aset[$safeKey] ?? ($detail['details']['new_unit_price'] ?? 0);
                                $idrFinal = $idrNew > 0 ? $idrNew : $idrOld;
                            ...
                            <tr
                                ...
                                {{-- USD OLD --}}
                                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white text-right">
                                    {{ number_format($usdOld, 2, ',', '.') }}
                                </td>

                                {{-- USD NEW (editable) --}}
                                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white text-right">
                                    @if ($editingItemId === 'usd_' . $safeKey)
                                        <input autofocus wire:model="new_unit_price_usd_raw_aset.{{ $safeKey }}"
                                            type="text"
                                            class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block px-2.5 py-1 dark:bg-gray-700 dark:border-gray-600 dark:text-white text-right"
                                            placeholder="0"
                                            wire:blur="formatToUSDNewPriceAset('{{ $safeKey }}')"
                                            @if ($status_finance === 'Disetujui') disabled @endif />
                                    @else
                                        @if ($status_finance !== 'Disetujui')
                                            <span class="cursor-pointer"
                                                wire:click="editItemPriceImporAset('usd','{{ $safeKey }}')">
                                                {{ number_format($usdNew, 2, ',', '.') }}
                                            </span>
                                        @else
                                            {{ number_format($usdNew, 2, ',', '.') }}
                                        @endif
                                ...
                                {{-- IDR OLD --}}
                                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white text-right">
                                    {{ number_format($idrOld, 0, ',', '.') }}
                                </td>

                                {{-- IDR NEW (editable) --}}
                                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white text-right">
                                    @if ($editingItemId === 'idr_' . $safeKey)
                                        <input autofocus wire:model="new_unit_price_raw_aset.{{ $safeKey }}"
                                            type="text"
                                            class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block px-2.5 py-1 dark:bg-gray-700 dark:border-gray-600 dark:text-white text-right"
                                            placeholder="0"
                                            wire:blur="formatToRupiahNewPriceAset('{{ $safeKey }}')"
                                            @if ($status_finance === 'Disetujui') disabled @endif />
                                    @else
                                        @if ($status_finance !== 'Disetujui')
                                            <span class="cursor-pointer"
                                                wire:click="editItemPriceImporAset('idr','{{ $safeKey }}')">
                                                {{ number_format($idrNew, 0, ',', '.') }}
                                            </span>
                                        @else
                                            {{ number_format($idrNew, 0, ',', '.') }}
                                        @endif
                                ...
                                {{-- TOTAL IDR --}}
                                <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white text-right">
                                    {{ number_format($subIDR, 0, ',', '.') }}
                                </td>

                                <td class="px-6 py-4 text-gray-900 dark:text-white text-center">
                                    {{ $detail['penanggungjawabaset'] ?? '-' }}
                                </td>
                                <td class="px-6 py-4 text-gray-900 dark:text-white text-center">
                                    {{ $detail['alasan'] ?? '-' }}
                                </td>
                                <td class="px-6 py-4">
                                    <textarea wire:model="keterangan_pembayaran.{{ $safeKey }}"
                                        ...
                                        @if ($status_finance === 'Disetujui') disabled @endif></textarea>
                                </td>
                            </tr>
                        @endforeach
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white text-right">
                                <strong>Rp</strong> {{ number_format($grandIDR + ($ppn ?? 0), 0, ',', '.') }}
                            </td>
                        </tr>
                    </tbody>
                </table>
