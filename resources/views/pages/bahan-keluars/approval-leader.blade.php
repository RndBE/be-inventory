...
<div
    x-data="{ isOpen: @entangle('isApproveLeaderModalOpen') }"
    x-show="isOpen"
...
>
        <div class="relative p-2 pt-2 w-full max-w-md bg-white rounded-lg shadow dark:bg-gray-700 overflow-y-auto"
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button wire:click="closeModal" type="button" @click="isOpen = false; $wire.closeModal();" class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
