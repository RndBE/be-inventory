<!-- Main modal -->
<div wire:ignore.self id="showbahankeluar-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 pt-12 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-2 dark:border-gray-600">
                <button type="button" class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="showbahankeluar-modal">
                ...
                <div class="w-[350px] rounded bg-gray-50 px-6 m-4 shadow-lg">
                    ...
                    <div class="flex flex-col gap-3 pb-6 pt-2 text-xs">
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                @if (!empty($this->bahanKeluarDetails)) <!-- Cek apakah ada data -->
