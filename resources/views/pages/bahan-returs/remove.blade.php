<div wire:ignore.self id="deletebahanreturs-modal" tabindex="-1" aria-hidden="{{ !$isModalOpen }}" class="{{ $isModalOpen ? '' : 'hidden' }} overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <div class="flex justify-center gap-4">
                    <form action="{{ route('bahan-returs.destroy', (int)$id_bahan_returs) }}" method="POST" class="inline-flex">
                        @csrf
                        @method('DELETE')
