...
<head>
    ...
    <title>FORM PENGAJUAN BAHAN RUSAK</title>
    <style>
        body {
...
<body>
    ...
    <!-- Centered H3 -->
    <h3 class="pt-6">FORM PENGAJUAN BAHAN RUSAK PT. ARTA TEKNOLOGI COMUNINDO</h3>
    ...
    <table style="border: 1px solid black;width: 100%;border-collapse: collapse;padding-top:10;">
        <tr style="text-align: left;vertical-align: top;">
            ...
            <td style="border: 1px solid black">: {{ $bahanRusak->kode_transaksi }}</td>
        </tr>
        <tr style="text-align: left;vertical-align: top;">
            <td style="border: 1px solid black;width: 30%;"><strong>Divisi</strong></td>
            <td style="border: 1px solid black">: {{ $divisi }}</td>
        </tr>
        <tr>
    ...
    <table style="border: 1px solid black;width: 100%;border-collapse: collapse;padding-top:10;">
        ...
        <tbody>
            @php
                $totalSubTotal = 0;
            @endphp
            @foreach ($bahanRusak->bahanRusakDetails as $index => $detail)
                @php
