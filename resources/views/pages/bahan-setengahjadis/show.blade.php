                            ...
                            <tbody>
                                ...
                                <tr class="border-b border-slate-200">
                                    <td class="py-4 pl-4 pr-3 text-sm sm:pl-6 md:pl-0">
                                        <img src="{{ $detail->gambar ? Storage::url('bahan-setengah-jadi/' . $detail->gambar) : asset('images/image-4@2x.jpg') }}" alt="Gambar {{ $detail->nama_bahan }}" class="h-auto w-24 rounded-lg">
                                    </td>
                                    <td class="py-4 pl-4 pr-3 text-sm sm:pl-6 md:pl-0">
