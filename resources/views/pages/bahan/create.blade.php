                    ...
                    <div class="border-b border-gray-900/10 pb-12">
                        <div class="p-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-2" x-data="{
                                ...
                                selected: [
                                    @foreach(old('supplier_id', []) as $sid)
                                        '{{ $sid }}',
                                    @endforeach
                                ],
                                open: false,
                                ...
                                <div class="mt-2 text-sm">
                                    <!-- Selected Chips -->
                                    <div class="flex flex-wrap gap-2 mb-2" x-show="selectedOptions.length > 0" x-cloak>
                                    ...
                                    <div class="relative">
                                        ...
                                        <!-- Options List -->
                                        <ul x-show="open" x-transition x-cloak class="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm dark:bg-gray-700">
