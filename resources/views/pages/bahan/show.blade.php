            ...
            <div class="pt-0 p-5">
                <div class="p-4">
                    ...
                    <ul class="my-4 space-y-3">
                        ...
                        <li><h6>Total Stok: <span class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-green-400 border border-green-400">{{ $total_stok_label ?? $total_stok . ' ' . $unit_id }}</span></h6></li>
