@section('title', 'Update Garansi Proyek | BE INVENTORY')
<x-app-layout>
    @props(['variant' => ''])
        ...
        <div class="flex items-center space-x-3">
            <div class="p-1 flex items-center justify-end gap-x-2">
                @if($projek->status !== 'Selesai')
                    <a href="{{ route('garansi-projeks.index') }}" type="button" class="rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500" >Kembali</a>
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="w-full max-w-9xl mx-auto">
            <div class="flex flex-col items-start gap-6">
                ...
                <div class="w-full bg-white border rounded-lg p-6 shadow">
                    <form action="{{ route('garansi-projeks.update', $projek->id) }}" method="POST" enctype="multipart/form-data" id="produksiForm">
                        @csrf
                        ...
                        <div class="space-y-6">
                            <div>
                                <div class="border-b border-gray-900/10 pb-2 mb-2">
                                    <div class="grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-2">
                                        <div class="flex items-center">
                                            ...
                                            <input type="text" id="kode_garansi" value="{{ $projek->kode_garansi }}" disabled placeholder="PR - " class="block rounded-md w-3/4 border-gray-300 bg-gray-100 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" readonly>
                                        </div>
                                        <div class="flex items-center">
                                            <label for="kontrak_id" class="block text-sm font-medium leading-6 text-gray-900 mr-2 w-1/4 dark:text-white">Garansi Proyek
                                        ...
                                        <div class="flex items-center">
                                            <label for="mulai_garansi" class="block text-sm font-medium leading-6 text-gray-900 mr-2 w-1/4">Mulai Garansi<sup class="text-red-500 text-base">*</sup></label>
                                ...
                                <livewire:edit-bahan-garansi-projek-cart :projekId="$projekId" />
                            </div>
                        </div>
                    </form>
                </div>
    ...
    @include('pages.garansi-projek.selesai')
    <script>
