...
<div x-data="{ isOpen: @entangle('isApproveFinanceModalOpen') }"
    x-show="isOpen"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="pt-0 p-5">
                <form class="formeditdata space-y-6" method="post" action="{{ route('pengajuan-pembelian-bahan.updateApprovalFinance', (int)$id_pembelian_bahan) }}">
                    ...
                    <div x-data="{ statusFinance: '{{ $status_finance }}' }">
                        <label for="status_finance" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Status Finance</label>
                        <select x-model="statusFinance" name="status_finance" id="status_finance" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                        ...
                        <div x-show="statusFinance === 'Ditolak'" class="mt-4">
                    ...
                    @include('components.approval-kendala-field', [
                        'value' => \App\Models\ApprovalKendala::getKendala('pembelian_bahan', (int) $id_pembelian_bahan, 'Finance')
                    ])
