@section('title', 'Detail Transaksi Bahan Keluar | BE INVENTORY')
<x-app-layout>
                    ...
                    <div class="flex w-full">
                        <div class="grid grid-cols-4 gap-12">
                            ...
                            <div class="text-sm font-light text-slate-500">
                                ...
                                <p>{{ \Carbon\Carbon::parse($tgl_keluar)->format('d F Y H:i:s') }}</p> <!-- Format tanggal -->
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="min-w-full divide-y divide-slate-500">
                                    ...
                                    @foreach($bahanKeluarDetails as $detail)
                                        <tr class="border-b border-slate-200">
                                            ...
                                            <td class="hidden px-3 py-4 text-sm text-right text-slate-500 sm:table-cell">
                                                {{-- Bahan batangan qty-nya tersimpan dalam cm; qtyTampil()
                                                     menuliskannya kembali sebagai batang. --}}
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="pt-6 pl-3 pr-4 text-sm text-right text-slate-500 sm:pr-6 md:pr-0">Rp. {{ number_format($bahanKeluarDetails->sum('sub_total'), 2) }}</td>
                                </tr>
                ...
                <div class="mt-9 p-9">
                    <div class="border-t pt-9 border-slate-200">
                        <div class="mt-2 flex items-center justify-end gap-x-6">
                            <a href="{{ route('bahan-keluars.index') }}" type="button" class="text-sm font-semibold leading-6 text-gray-900">Kembali</a>
