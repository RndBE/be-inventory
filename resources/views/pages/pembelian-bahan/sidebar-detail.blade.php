<div x-data="{ openDetailSidebar: @entangle('isDetailOpen') }" @keydown.escape.window="openDetailSidebar = false">
    ...
    <div x-show="openDetailSidebar" @click="openDetailSidebar = false" x-transition.opacity
        class="fixed inset-0 bg-black bg-opacity-30 z-40" style="display: none"></div>

    <!-- Sidebar -->
    <div x-show="openDetailSidebar" x-transition:enter="transition ease-out duration-300"
        x-transition:enter-start="translate-x-full" x-transition:enter-end="translate-x-0"
        x-transition:leave="transition ease-in duration-200" x-transition:leave-start="translate-x-0"
        x-transition:leave-end="translate-x-full"
        class="fixed top-0 right-0 z-50 w-full max-w-md h-full bg-white shadow-lg overflow-y-auto" style="display: none"
                ...
                <div class="flex w-full items-center justify-center">
                    <div class="w-[350px] rounded bg-gray-50 px-6 m-4 shadow-lg">
                        ...
                        <div class="flex flex-col justify-center items-center gap-2">
                            ...
                            <p class="text-xs text-center">Kadirojo I, Purwomartani, Kec. Kalasan, Kabupaten Sleman,
                                ...
                                <tbody>
                                    @if (!empty($this->pembelianBahanDetails))
                                            ...
                                            <tr class="flex">
                                                ...
                                                <td class="flex-1">
                                                    @if ($newUnitPrices->new_unit_price ?? false)
                                                        <span
                                                            class="line-through text-red-500">{{ number_format($unitPrices->unit_price ?? 0) }}</span>
                                                    @else
                                                ...
                                                <td class="w-full text-right">
                                                    @if ($newUnitPrices->new_unit_price ?? false)
                                                        <span
                                                            class="line-through text-red-500">{{ number_format($detail->jml_bahan * ($unitPrices->unit_price ?? 0)) }}</span>
                                                    @else
                                        ...
                                        <tr class="flex">
                                            ...
                                            <td class="w-[150px] text-right">{{ number_format($ppn, 2, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr class="flex">
                                            <td class="flex-1 py-1"></td>
                                            <td class="w-[150px] text-right"><strong>Ongkos Kirim: </strong></td>
                                            <td class="w-[150px] text-right">{{ number_format($ongkir, 2, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr class="flex">
                                            <td class="flex-1 py-1"></td>
                                            ...
                                            <td class="w-[150px] text-right">
                                                {{ number_format($asuransi, 2, ',', '.') }}</td>
                                        </tr>
                                        <tr class="flex">
                                            <td class="flex-1 py-1"></td>
                                            <td class="w-[150px] text-right"><strong>Layanan: </strong></td>
                                            <td class="w-[150px] text-right">{{ number_format($layanan, 2, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr class="flex">
                                            <td class="flex-1 py-1"></td>
                                            ...
                                            <td class="w-[150px] text-right">
                                                {{ number_format($jasa_aplikasi, 2, ',', '.') }}</td>
                                        </tr>
                                        <tr class="flex">
                                            <td class="flex-1 py-1"></td>
                                    ...
                                    @else
                                        <tr>
                                            <td colspan="3" class="text-center py-2">Tidak ada detail bahan keluar
                                                yang ditemukan.</td>
                                        </tr>
                                    @endif
                                </tbody>
                                            ...
                                            <td class="w-[150px] text-right">Rp.
                                                @php
                                                    $finalTotal =
                                                        ...
                                                        ($new_full_amount_fee > 0
                                                            ? $new_full_amount_fee
                                                            : $full_amount_fee) +
                                                        ($new_value_today_fee > 0
                                                            ? $new_value_today_fee
                                                            : $value_today_fee);
                                                @endphp
                                ...
                                <tbody>
                                    @if (!empty($this->pembelianBahanDetails))
                                        ...
                                        <tr class="flex">
                                            ...
                                            <td class="w-[150px] text-right"><strong>Shipping Cost: </strong></td>
                                            <td class="w-[150px] text-right">
                                                {{ number_format($shipping_cost, 2, ',', '.') }}</td>
                                        </tr>
                                        <tr class="flex">
                                            <td class="flex-1 py-1"></td>
                                            <td class="w-[150px] text-right"><strong>Full Amount Fee: </strong></td>
                                            <td class="w-[150px] text-right">
                                                {{ number_format($full_amount_fee, 2, ',', '.') }}</td>
                                        </tr>
                                        <tr class="flex">
                                            <td class="flex-1 py-1"></td>
                                            <td class="w-[150px] text-right"><strong>Value Today Fee: </strong></td>
                                            <td class="w-[150px] text-right">
                                                {{ number_format($value_today_fee, 2, ',', '.') }}</td>
                                        </tr>
                                        <tr class="flex">
                                            <td class="flex-1 py-1"></td>
                                            <td class="w-[150px] text-right"><strong>Total Harga: </strong></td>
