...
<div x-data="{ isOpen: @entangle('isUploadDokumenModalOpen') }"
    x-show="isOpen"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                    Upload Dokumen Pembatalan Pengajuan
                </h3>
            ...
            <!-- Modal body -->
            <div class="pt-0 p-5">
                <form class="formeditdata space-y-6" method="post" action="{{ route('pengajuan-pembelian-bahan.uploadDokumenPembelian', (int)$id_pembelian_bahan) }}" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT') }}
                    <input type="hidden" name="page" value="{{ $currentPage }}">
                    <div>
                        <label for="link" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Dokumen Pembatalan Pengajuan</label>
                         <input
                            type="file"
                            id="dokumen"
                            name="dokumen"
