...
<x-app-layout>
    ...
    <x-app.secondary-header :variant="$attributes['headerVariant']">
        ...
        <div class="flex items-center space-x-3">
            <div class="p-1 flex items-center justify-end gap-x-2">
                <a href="{{ route('pengajuan-pembelian.index') }}" type="button" class="rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">Kembali</a>
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="w-full bg-white border border-gray-200 rounded-lg p-4 shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
            <form action="{{ route('pengajuan-pembelian.store') }}" method="POST" enctype="multipart/form-data" id="pengajuanForm">
                @csrf
                <div class="space-y-6">
    ...
    @include('pages.pengajuan-pembelian.konfirmsimpan')
    <script>
