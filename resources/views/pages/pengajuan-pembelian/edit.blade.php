@section('title', 'Edit Pengajuan Pembelian | BE INVENTORY')
<x-app-layout>
    @props(['variant' => ''])
                ...
                <div class="w-full md:block md:w-auto">
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        <li class="flex items-center">
                            <span class="text-xs">Edit Pengajuan Pembelian</span>
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <form action="{{ route('pengajuan-pembelian.update', $pembelian_bahan->id) }}" method="POST" enctype="multipart/form-data" id="produksiForm">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <livewire:edit-pengajuan-pembelian-cart :pembelianBahanId="$pembelianBahanId" />
                    </div>
                </div>
            </form>
        </div>
