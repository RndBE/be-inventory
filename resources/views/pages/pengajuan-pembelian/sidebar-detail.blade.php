                                ...
                                <tbody>
                                    @if (!empty($this->pembelianBahanDetails))
                                        ...
                                        <tr class="flex">
                                            <td class="flex-1 py-1"></td>
                                            <td class="w-[150px] text-right"><strong>Shipping Cost: </strong></td>
                                            <td class="w-[150px] text-right">{{ number_format($shipping_cost, 2, ',', '.') }}</td>
                                        </tr>
                                        <tr class="flex">
                                            <td class="flex-1 py-1"></td>
                                            <td class="w-[150px] text-right"><strong>Full Amount Fee: </strong></td>
                                            <td class="w-[150px] text-right">{{ number_format($full_amount_fee, 2, ',', '.') }}</td>
                                        </tr>
                                        <tr class="flex">
                                            <td class="flex-1 py-1"></td>
                                            <td class="w-[150px] text-right"><strong>Value Today Fee: </strong></td>
                                        ...
                                        <tr class="flex">
                                            ...
                                            <td class="w-[150px] text-right">Rp.
                                                @php
                                                    $finalTotal = $totalWithExtras + ($shipping_cost ?? 0)
                                                                + ($full_amount_fee ?? 0)
                                                                + ($value_today_fee ?? 0);
                                                @endphp
                                                {{ number_format($finalTotal, 2, ',', '.') }}
