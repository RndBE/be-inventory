@section('title', 'Detail Transaksi Produk Jadi | BE INVENTORY')
<x-app-layout>
                ...
                <div class="p-9">
                    <div class="flex flex-col mx-0 mt-8">
                        ...
                        <table class="min-w-full divide-y divide-slate-500">
                            ...
                            <tbody>
                                @foreach($ProdukJadiDetails as $detail)
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="pt-6 pl-3 pr-4 text-sm text-right text-slate-500 sm:pr-6 md:pr-0">Rp. {{ number_format($ProdukJadiDetails->sum('sub_total'), 2) }}</td>
                                </tr>
                ...
                <div class="p-9">
                    <div class="flex flex-col mx-0 mt-8">
                        ...
                        <table class="min-w-full divide-y divide-slate-500">
                            ...
                            <tbody>
                                @php
                                    $details = $produksiProdukJadiDetails->isNotEmpty() ? $produksiProdukJadiDetails : $projekRndDetails;
                                    // dd($details);
                ...
                <div class="mt-9 p-9">
                    <div class="border-t pt-9 border-slate-200">
                        <div class="mt-2 flex items-center justify-end gap-x-6">
                            <a href="{{ route('produk-jadi.index') }}" type="button" class="rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">Kembali</a>
