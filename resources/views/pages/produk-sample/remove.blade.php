    ...
    <div class="relative p-4 w-full max-w-md max-h-full"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah Anda yakin ingin menghapus produk sample?</h3>
                <div class="flex justify-center gap-4">
                    <form action="{{ route('produk-sample.destroy', (int)$id_produkSample) }}" method="POST" class="inline-flex">
                        {{ csrf_field() }}
                        {{ method_field('DELETE') }}
