                    ...
                    <div class="flex w-full">
                        <div class="grid grid-cols-4 gap-12">
                            ...
                            <div class="text-sm font-light text-slate-500">
                                ...
                                <p class="text-sm font-normal text-slate-700">{{ $nama_produk }}</p>
                            </div>
                            <div class="text-sm font-light text-slate-500">
                                ...
                                <p>{{ \Carbon\Carbon::parse($mulai_produksi)->format('d F Y H:i:s') }}</p> <!-- Format tanggal -->
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="min-w-full divide-y divide-slate-500">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="pt-6 pl-3 pr-4 text-sm text-right text-slate-500 sm:pr-6 md:pr-0">Rp. {{ number_format($produksiDetails->sum('sub_total'), 2) }}</td>
                                </tr>
