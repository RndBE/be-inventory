                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('purchases.index') }}"
                                    class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Bahan
                                    Masuk</a>
                            </div>
                        </li>
            ...
            <div class="flex flex-col lg:flex-row items-start gap-6">
                ...
                <div class="w-full lg:w-3/4 bg-white border rounded-lg p-6 shadow">
                    <form action="{{ route('purchases.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-6">
                            <div
                                class="grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-1 border-b border-gray-900/10 pb-2">
                                <div class="flex items-center">
                                    <label for="kode_transaksi"
                                        class="block text-sm font-medium leading-6 text-gray-900 mr-2 w-1/4">Kode
                                        Transaksi</label>
                                    <input type="text" id="kode_transaksi" disabled placeholder="KBM - "
                                ...
                                <div class="flex items-center">
                                    <label for="divisi"
                                        class="block text-sm font-medium leading-6 text-gray-900 mr-2 w-1/4">
                                    ...
                                    <div class="relative w-3/4">
                                        ...
                                        <input type="text" name="tgl_masuk" id="datetimepicker"
                                            value="{{ old('tgl_masuk') }}" placeholder="Pilih tanggal"
                                ...
                                <div class="flex items-center">
                                    <label for="no_invoice"
                                        class="block text-sm font-medium leading-6 text-gray-900 mr-2 w-1/4">No
                                        Invoice</label>
                                    <input type="text" name="no_invoice" id="no_invoice"
                                        placeholder="Masukkan Invoice"
                                        class="block rounded-md w-3/4 border-gray-300 bg-white-100 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>

                                <div class="flex items-center">
                                    <label for="text"
                                        class="block text-sm font-medium leading-6 text-gray-900 mr-2 w-1/4"></label>
                        ...
                        <div class="mt-2 flex items-center justify-end gap-x-2">
                            ...
                            {{-- <button type="submit" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Simpan
                            </button> --}}
                            <button type="submit" id="btnSubmit"
                                class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                                disabled>Simpan
                            </button>
