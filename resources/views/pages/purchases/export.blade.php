        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="pt-0 p-5">
                <form action="{{ route('purchases-export.export') }}" method="GET">
                    ...
                    <div>
                        <button class="text-white inline-flex w-full justify-center bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" type="submit">
                            Unduh
                        </button>
                    </div>
                </form>
