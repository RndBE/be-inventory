...
<x-app-layout>
                    ...
                    <ol class="flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Edit Rekap Aset</span>
                            </div>
                        </li>
                    </ol>
                </nav>
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="w-full bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
            <form action="{{ route('rekap-aset.update', $rekap_aset->id) }}" method="POST" enctype="multipart/form-data" id="asetForm">
                @csrf
                @method('PUT')
                <div class="space-y-12">
                    <div class="border-b border-gray-900/10 pb-12">
                        <div class="p-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="mt-2">
                                <input value="{{ old('nomor_aset', $rekap_aset->nomor_aset ?? '') }}" type="text" name="nomor_aset" id="nomor_aset" autocomplete="address-level2" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" placeholder="INV/ATC/CHAIR-001/DIR/2025">
                                @error('nomor_aset')
                            ...
                            <div class="mt-2">
                                <input value="{{ old('serial_number', $rekap_aset->serial_number ?? '') }}" type="text" name="serial_number" id="serial_number" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" placeholder="SN-XXXXXXXXXX">
                                @error('serial_number')
                                    <p class="text-red-500 text-sm mt-1 error-message">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mt-2">
                                <input value="{{ old('merek', $rekap_aset->merek ?? '') }}" type="text" name="merek" id="merek" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" placeholder="mis. Lenovo ThinkPad E14">
                                @error('merek')
                                    <p class="text-red-500 text-sm mt-1 error-message">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <select id="barang_aset_id" name="barang_aset_id" autocomplete="country-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
                                        <option value="" disabled>Pilih Barang</option>
                                        @foreach($barangAset as $barang)
                                            <option value="{{ $barang->id }}"
                                                {{ old('barang_aset_id', $rekap_aset->barang_aset_id) == $barang->id ? 'selected' : '' }}>
                                                {{ $barang->nama_barang }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <input value="{{ old('link_gambar', $rekap_aset->link_gambar ?? '') }}" type="text" name="link_gambar" id="link_gambar" autocomplete="street-address" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
                                    @error('link_gambar')
                                        <p class="text-red-500 text-sm mt-1 error-message">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <input value="{{ old('harga_perolehan', $rekap_aset->harga_perolehan ?? '') }}" type="text" name="harga_perolehan" id="harga_perolehan" autocomplete="address-level2" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <select id="kondisi" name="kondisi" autocomplete="country-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
                                        ...
                                        <option value="Baik" {{ old('kondisi', $rekap_aset->kondisi ?? '') == 'Baik' ? 'selected' : '' }}>Baik</option>
                                        <option value="Rusak" {{ old('kondisi', $rekap_aset->kondisi ?? '') == 'Rusak' ? 'selected' : '' }}>Rusak</option>
                                    </select>
                                    @error('kondisi')
                                        <p class="text-red-500 text-sm mt-1 error-message">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="mt-2">
                                    <select id="user_id" name="user_id" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
                                        ...
                                        @foreach($dataUser as $user)
                                            <option value="{{ $user->id }}" {{ old('user_id', $rekap_aset->user_id) == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('user_id')
                                        <p class="text-red-500 text-sm mt-1 error-message">{{ $message }}</p>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <select id="pic_id" name="pic_id" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
                                        ...
                                        @foreach($dataUser as $user)
                                            <option value="{{ $user->id }}" {{ old('pic_id', $rekap_aset->pic_id) == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('pic_id')
                                        <p class="text-red-500 text-sm mt-1 error-message">{{ $message }}</p>
                                ...
                                <div class="mt-2">
                                    <select id="ruangan_id" name="ruangan_id" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
                                        ...
                                        @foreach($dataRuangan as $ruangan)
                                            <option value="{{ $ruangan->id }}" {{ old('ruangan_id', $rekap_aset->ruangan_id) == $ruangan->id ? 'selected' : '' }}>{{ $ruangan->nama_ruangan }}</option>
                                        @endforeach
                                    </select>
                                    @error('ruangan_id')
                                        <p class="text-red-500 text-sm mt-1 error-message">{{ $message }}</p>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <textarea id="keterangan" name="keterangan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{ old('keterangan', $rekap_aset->keterangan ?? '') }}</textarea>
                                    @error('keterangan')
                                        <p class="text-red-500 text-sm mt-1 error-message">{{ $message }}</p>
                                    @enderror
                                </div>
