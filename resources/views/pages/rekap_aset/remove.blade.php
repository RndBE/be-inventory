    ...
    <div class="relative p-4 w-full max-w-md max-h-full" x-show="isOpen"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah Anda yakin ingin menghapus <span class="font-semibold text-gray-900 dark:text-white">{{ $nomor_aset }}</span>?</h3>
                <div class="flex justify-center gap-4">
                    <form action="{{ route('rekap-aset.destroy', (int)$id_barang) }}" method="POST" class="inline-flex">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
