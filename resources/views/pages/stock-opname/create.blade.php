                ...
                <div class="space-y-6">
                    {{-- <div class="border-b border-gray-900/10 pb-2">
                        <div class="mt-1 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <label for="nomor_referensi" class="block text-sm font-medium leading-6 text-gray-900">Nomor Referensi</label>
                            <div class="mt-2">
                                <input type="text" id="nomor_referensi" placeholder="Ref - " class="block w-full rounded-md border-gray-50 bg-gray-50 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                <input type="text" id="nomor_referensi" placeholder="Ref - " class="block w-full rounded-md border-gray-50 bg-gray-50 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                <label for="datepicker-autohide" class="block text-sm font-medium leading-6 text-gray-900">Tanggal</label>
                                <div class="mt-2">
