...
<div wire:ignore.self id="deletestockopname-modal" tabindex="-1" aria-hidden="true" class="fixed inset-0 flex items-center justify-center z-50 w-full h-full bg-black bg-opacity-50" wire:click.self="closeModal">
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah Anda yakin ingin menghapus stock opname?</h3>
                <div class="flex justify-center gap-4">
                    <form action="{{ route('stock-opname.destroy', (int)$id_stock_opname) }}" method="POST" class="inline-flex">
                        @csrf
                        @method('DELETE')
