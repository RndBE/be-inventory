        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="pt-0 p-5">
                ...
                @csrf
                    ...
                    <div>
                        <label for="nama_pic" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama PIC</label>
                        <input autofocus type="text" name="nama_pic" id="nama_pic" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Masukkan Nama PIC">
                    </div>
                    <div>
                        <label for="keterangan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Keterangan <span class="text-gray-500 font-normal">(Nama Barang/Jasa)</span></label>
                        <textarea name="keterangan" id="keterangan" rows="3" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Contoh: Pembelian komponen elektronik, PCB, kabel, dll."></textarea>
                    </div>
