            ...
            <div class="w-full bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <form action="{{ route('users.store') }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nomor_id" value="{{ old('nomor_id') }}" placeholder="mis. 003/HRDCS/II/2026" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                        @error('nomor_id')
