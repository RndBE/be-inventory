...
Route::middleware(['auth:sanctum', 'verified', 'isAdmin'])->group(function () {
    ...
    Route::get('bahan-keluars-export', [BahanKeluarController::class, 'exportExcel'])->name('bahan-keluars.exportExcel');
    ...
    Route::put('produksis/{produksi}/keluarkan-sebagian', [ProduksiController::class, 'keluarkanSebagian'])->name('produksis.keluarkanSebagian');
    ...
    Route::post('produk-sample/{produk}/kirim-ke-qc', [ProdukSampleController::class, 'kirimKeQc'])->name('produk-sample.kirimKeQc');
    ...
    Route::get('/download-template-laporan', function () {
        return response()->download(public_path('templates/template_laporan_proyek.xlsx'));
